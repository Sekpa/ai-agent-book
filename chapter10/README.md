...
1. [先比较角色切换与技能加载的行为边界 ](multi-role-transfer/README.md)。
2. [再理解文件如何承载长产物而不占满管理者上下文 ](book-translation/README.md)。
3. [最后用状态明确的多人任务观察消息与私有信息边界 ](voice-werewolf/README.md)。
