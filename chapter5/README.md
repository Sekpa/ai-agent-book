...
1. [先用离线求解器理解自然语言条件如何变成可检查的约束 ](code-for-logic/README.md)。
2. [再跟踪读取、修改、执行和修正组成的编码循环 ](coding-agent/README.md)。
3. [最后把循环用于可见产物，检查代码变化是否满足用户需求 ](conversational-ui/README.md)。
