...
1. [先用离线偏好对理解训练希望改变的行为 ](premature-completion-dpo/README.md)。
2. [再检查教师轨迹怎样成为可用的监督数据 ](cot-distillation/README.md)。
3. [最后结合小模型比较预训练、监督微调和偏好训练的分工 ](MiniMind-pretrain/README.md)。
