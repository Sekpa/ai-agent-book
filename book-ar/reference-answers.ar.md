...
**7. (★★★) تحرز إحدى استراتيجيات الاستكشاف في إعادة تشغيل التاريخ أعلى الدرجات على جميع أشجار الاكتشاف القديمة، لكنها تتدهور في الجولة التالية من الاستكشاف عبر الإنترنت. ما انحيازات نطاق الدعم والعشوائية وفرط ملاءمة التقييم التي قد تُفضي إلى هذه النتيجة؟ وكيف تقسّم عوالم إعادة التشغيل وتصمّم بوابات الإصدار؟**

> لا تغطي الأشجار القديمة إلا الحالات والفروع التي زارتها السياسات السابقة، ولا تثبت الأداء في المناطق غير المستكشفة. وقد تتغير المهام والأدوات والبيئة عبر الإنترنت أيضاً. يمكن للبذور العشوائية وأخذ عينات النموذج وضجيج الأدوات تغيير الترتيب، بينما يؤدي الاختيار المتكرر على الأشجار نفسها إلى فرط ملاءمة التقييم. قسّم عوالم التطوير والتحقق والاختبار المحجوز بحسب عائلة المهام والزمن والشجرة المستقلة؛ وأبقِ كل شجرة ومساراتها المشتقة في مجموعة واحدة. ثبّت إصدارات النموذج والأدوات وميزانية الحوسبة، وقارن بالسياسة المرجعية عبر تشغيلات مقترنة ببذور متعددة، مع عرض التحسن وعدم اليقين والتكلفة والمخالفات. حدّد مسبقاً عتبات الجودة والسلامة والتكلفة. بعد النجاح دون اتصال، اشترط تجربة مضبوطة صغيرة عبر الإنترنت تدعم التحسن دون تراجع مؤشرات الحماية، ثم انشر تدريجياً مع شروط للتراجع.
