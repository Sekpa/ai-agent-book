...
1. [先把轨迹变成带具体证据的诊断 ](trajectory-verifier/README.md)。
2. [再观察一条诊断怎样引出可检查的最小补丁 ](prompt-auto-optimization/README.md)。
3. [最后用任务流检查学习、迁移、修订与保持 ](self-evolution-eval/README.md)。
